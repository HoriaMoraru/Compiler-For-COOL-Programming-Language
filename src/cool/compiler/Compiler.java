...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final ASTConstructionVisitor astConstructionVisitor = new ASTConstructionVisitor();
        final ASTNode ast = astConstructionVisitor.visit(globalTree);

//        final PrintVisitor printVisitor = new PrintVisitor();
//        ast.accept(printVisitor);

        final ClassDefinitionPassVisitor classDefinitionPassVisitor = new ClassDefinitionPassVisitor();
        ast.accept(classDefinitionPassVisitor);

        final ClassResolutionPassVisitor classResolutionPassVisitor =
                new ClassResolutionPassVisitor();
        ast.accept(classResolutionPassVisitor);

        final CycleDetectionAndDefinitionPassVisitor cycleDetectionAndDefinitionPassVisitor = new CycleDetectionAndDefinitionPassVisitor();
        ast.accept(cycleDetectionAndDefinitionPassVisitor);

        final ResolutionPassVisitor resolutionPassVisitor = new ResolutionPassVisitor();
        ast.accept(resolutionPassVisitor);

        final TypeCheckingPassVisitor typeCheckingPassVisitor = new TypeCheckingPassVisitor();
        ast.accept(typeCheckingPassVisitor);
